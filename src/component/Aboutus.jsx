        ...
        <div className="flex flex-col lg:flex-row items-start gap-8">
          ...
          <div className="lg:w-100  self-center ">
            <div className=" xl:p-6 space-y-8  tracking-[0.4px]">
              ...
              <button
                onClick={openForm}
                className="bg-[var(--button-bg)] cursor-pointer text-white px-4 py-3 xl:px-8 xl:py-3 text-xs xl:text-sm font-medium rounded-[30px] tracking-[1.5px] hover:bg-[var(--secondary-bg)] transition-colors duration-300"
              >
                Enquire Now
              </button>
            </div>
