    ...
    isOpen && (
      ...
      >
        <div className="xl:!max-w-[40%] p-[30px] text-white relative text-center tracking-[1.5px] uppercase">
          ...
          {error && (
            <div className="mb-4 p-3 rounded bg-red-600 text-white">{error}</div>
          )}
            ...
            <form onSubmit={onSubmit} className="space-y-6 z-[99]">
              <div>
                ...
                {errors.name && touched.name && (
                  <p className="text-start mt-[4px] text-red-600 text-xs mt-1">{errors.name}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.email && touched.email && (
                  <p className="text-start mt-[4px] text-red-600 text-xs mt-1">{errors.email}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.contact && touched.contact && (
                  <p className="text-start mt-[4px] text-red-600 text-xs mt-1">{errors.contact}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.message && touched.message && (
                  <p className="text-start mt-[4px] text-red-600 text-xs mt-1">{errors.message}</p>
                )}
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                >
                  I hereby consent to Grooup 108 & its authorized partners contacting me via Call/SMS/Email/WhatsApp. This will override the DND/NDNC settings. T&C Apply.
                </label>
              </div>
              {errors.authorize && touched.authorize && (
                <p className="text-start mt-[4px] text-red-600 text-xs mt-1">{errors.authorize}</p>
              )}
